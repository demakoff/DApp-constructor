export function getPropertyLine(args) {
    ...
    const resultElementNode = resultNode.querySelector(`.result__${args.name} [data-args-container]`);
    ...
    if (args.inputs.length) {
        const callButtonNode = resultNode.querySelector(`.result__${args.name} [data-call-button]`);
